...
public class Menu {
	...
	private static void criarContasTeste() {
		contaController.cadastrar(
				new ContaCorrente(contaController.gerarNumero(), 123, 1, "Joao da Silva", 1000.00f, 100.00f));
		contaController.cadastrar(
	...
	private static void atualizarConta() {
		...
		if (conta != null) {
			...
			System.out.printf("\nA conta numero %d nao foi encontrada!\n", numero);
		}
	...
	public static void sobre() {
		System.out.println(Cores.TEXT_YELLOW + Cores.ANSI_BLACK_BACKGROUND
				+ "\n*****************************************************");
		System.out.println("Projeto Desenvolvido por: Thiago Lima Santos         ");
		System.out.println("Generation Brasil - thiagos@genstudents.org          ");
		System.out.println("https://github.com/Thiagols623                       ");
		System.out.println("*****************************************************");
	}
